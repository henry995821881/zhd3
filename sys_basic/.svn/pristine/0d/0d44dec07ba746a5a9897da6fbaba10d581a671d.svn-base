...
public class WarehouseGoods implements Serializable{
	...
	public String toString() {
		return "WarehouseGoods [goodsId=" + goodsId + ", goodsCodebill="
				+ goodsCodebill + ", memberCode=" + memberCode + ", goodsDate="
				+ goodsDate + ", scontractBillcode=" + scontractBillcode
				+ ", scontractBillbatch=" + scontractBillbatch
				+ ", datasBalcorp=" + datasBalcorp + ", datasBalcorpname="
				+ datasBalcorpname + ", datasOrdercorp=" + datasOrdercorp
				+ ", datasOrdercorpname=" + datasOrdercorpname
				+ ", goodsMinnum=" + goodsMinnum + ", goodsInprice="
				+ goodsInprice + ", goodsInfeeprice=" + goodsInfeeprice
				+ ", goodsNewinprice=" + goodsNewinprice
				+ ", goodsNewinfeeprice=" + goodsNewinfeeprice
				+ ", goodsTaxrate=" + goodsTaxrate + ", goodsFulfill="
				+ goodsFulfill + ", dataInnerflag=" + dataInnerflag
				+ ", goodsRemark=" + goodsRemark + ", dataVernum=" + dataVernum
				+ ", billtypeCode=" + billtypeCode + ", sumgoodsBatch="
				+ sumgoodsBatch + ", warehouseCode=" + warehouseCode
				...
				+ goodsEntrystr5 + ", goodsCodebillold=" + goodsCodebillold
				+ ", goodsCodestr1=" + goodsCodestr1 + ", goodsCodestr2="
				+ goodsCodestr2 + ", goodsCodestr3=" + goodsCodestr3
				+ ", goodsCodestr4=" + goodsCodestr4 + ", goodsCodestr5="
				+ goodsCodestr5 + ", goodsCodestr6=" + goodsCodestr6
				+ ", goodsCodestr7=" + goodsCodestr7 + ", goodsCodestr8="
				+ goodsCodestr8 + ", goodsCodestr9=" + goodsCodestr9
				+ ", goodsCodestr10=" + goodsCodestr10 + ", goodsCodenum1="
				+ goodsCodenum1 + ", goodsCodenum2=" + goodsCodenum2
				+ ", goodsCodenum3=" + goodsCodenum3 + ", partsnameSplit="
				+ partsnameSplit + ", goodsProperty=" + goodsProperty
				...
				+ goodsAssistweight + ", goodsWmscodebill=" + goodsWmscodebill
				+ "]";
	}
