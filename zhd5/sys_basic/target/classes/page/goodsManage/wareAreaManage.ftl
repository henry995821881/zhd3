				...
				<ul class="menu_content Inquire">
					<form id="form_query">
					   <li class="menu_content_list">
						...
						<li class="menu_content_list">
							<span>库区：</span>
							<input type="text" name="wareareaName" id="wareareaName_" value="" />
						</li>
						<li class="menu_content_list">
							<span>货区：</span>
							<input type="text" name="wareareaGregion" id="wareareaGregion_" value="" />
						</li>
						<li class="menu_content_list">
				...
				<div class="add_table" id="add_table">
					...
					<ul class="add_table_content">
						<form  id="form_warearea">
							<li class="fl_l">
								<span>库区<b class="required">*</b>：</span>
							...
							<li class="text_r">
							     <input type="hidden" id="warehouseCode_2" name="warehouseCode" />
...
<%for(var i=0;i<data.length;i++){%>
						<tr class="table_detail">
							<td warehouseCode='<%=data[i].warehouseCode%>' data='<%=data[i].warehouseName%>'><%=data[i].warehouseName%></td>
