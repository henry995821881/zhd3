...
public class WarehouseSumGoods implements Serializable{
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private BigDecimal sumgoodsId;

    private String sumgoodsBatch;

    @Override
	public String toString() {
		return "WarehouseSumGoods [sumgoodsId=" + sumgoodsId
				+ ", sumgoodsBatch=" + sumgoodsBatch + ", memberCode="
				+ memberCode + ", goodsClass=" + goodsClass
				+ ", partsnameSplit=" + partsnameSplit + ", goodsMinnum="
				+ goodsMinnum + ", goodsInprice=" + goodsInprice
				+ ", goodsInfeeprice=" + goodsInfeeprice + ", goodsNewinprice="
				+ goodsNewinprice + ", goodsNewinfeeprice="
				+ goodsNewinfeeprice + ", goodsTaxrate=" + goodsTaxrate
				+ ", goodsPriceflag=" + goodsPriceflag + ", goodsFulfill="
				+ goodsFulfill + ", goodsRemark=" + goodsRemark
				+ ", dataInnerflag=" + dataInnerflag + ", dataVernum="
				+ dataVernum + ", warehouseCode=" + warehouseCode
    ...
    public BigDecimal getSumgoodsId() {
        return sumgoodsId;
    }

    public void setSumgoodsId(BigDecimal sumgoodsId) {
        this.sumgoodsId = sumgoodsId;
    }
    ...
    public BigDecimal getGoodsClass() {
        return goodsClass;
    }

    public void setGoodsClass(BigDecimal goodsClass) {
