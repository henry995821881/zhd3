...
public class BasicPartsNameVo implements Serializable{
    /**
	 * 
	 */
	...
	public String toString() {
		return "BasicPartsName [partsnameId=" + partsnameId + ", memberCode="
				+ memberCode + ", partsnameCode=" + partsnameCode
				+ ", partsnameName=" + partsnameName + ", partsnameMnemcode="
				+ partsnameMnemcode + ", pntreeName=" + pntreeName
				+ ", partsnameWorkcoe=" + partsnameWorkcoe
				+ ", partsnameFormula=" + partsnameFormula
				+ ", partsnameProperty1=" + partsnameProperty1
				+ ", partsnameProperty2=" + partsnameProperty2
				+ ", partsnameProperty3=" + partsnameProperty3
				+ ", partsnameProperty4=" + partsnameProperty4
				+ ", partsnameProperty5=" + partsnameProperty5
				+ ", partsnameScrapprice=" + partsnameScrapprice
				+ ", goodsTaxrate=" + goodsTaxrate + ", partsnamePrice="
				+ partsnamePrice + ", partsnameNumunit=" + partsnameNumunit
				+ ", partsnameWeightunit=" + partsnameWeightunit
				+ ", partsnamePriceun=" + partsnamePriceun + ", partsnameAmdi="
				+ partsnameAmdi + ", partsnameWedi=" + partsnameWedi
				+ ", partsnameRemark=" + partsnameRemark
				+ ", partsnameAdjustWeight=" + partsnameAdjustWeight
				+ ", partsnameState=" + partsnameState + ", pntreeNodecode="
				+ pntreeNodecode + ", industryCode=" + industryCode
				+ ", goodsPiecemode=" + goodsPiecemode + ", goodsWeightmode="
				+ goodsWeightmode + ", goodsMetering=" + goodsMetering
				+ ", goodsPriceun=" + goodsPriceun + ", goodsProperty="
				+ goodsProperty + ", basicShare=" + basicShare
				+ ", pntreeParentname=" + pntreeParentname + "]";
	}
    ...
    @NotEmpty(message="品名代码不能空",groups={UpdateGroup.class,DeleteGroup.class})
    private String partsnameCode;

    @NotEmpty(message="品名不能空",groups={SaveGroup.class})
    ...
    @DecimalMin(message="税率必须大于0的数字", value="0",groups={SaveGroup.class,UpdateGroup.class})
